...
<div data-role="header" data-position="fixed" data-position="fixed" style="overflow:hidden;background-color: #2595FF;">
	...
	<h1 style="color: white; text-shadow: none;">Reportes<img alt="" src="../images/COLEGIOTT.png" align="middle" width="14%" height="14%"  style="margin-top: -1em;"></h1>
     				...
     				<li onclick="">
                        <a href="">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Pagos por Día</h2>
                                <h3 class="ca-sub">Pagos por Día</h3>
                            </div>
                        </a>
                    </li>
                     <li onclick="">
                        <a  href="">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Pagos Atrasados</h2>
                                <h3 class="ca-sub">Consulta de Pagos Atrasados</h3>
                            </div>
                        </a>
                    </li>
                    <li onclick="">
                        <a  href="">
                            <span class="ca-icon">&#185;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Planes de Estudios</h2>
                                <h3 class="ca-sub">Planes de Estudios</h3>
                            </div>
                        </a>
                    </li>
                    <li onclick="">
                        <a  href="">
                            <span class="ca-icon">&#185;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Estadísticas de Calificaciones</h2>
                                <h3 class="ca-sub">Reporte</h3>
                            </div>
                        </a>
                    </li>
                    <li onclick="">
