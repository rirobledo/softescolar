...
    
    <div data-role="collapsible" style="background-color: #F2F5FA; display: none;" id="idCollapRegi" 
...
<br>
	...
	<div data-role="collapsible" id="idCollapConsulta" title="Clic para consultar pagos">
...
    	<div data-role="controlgroup" >
		...
		<!-- 	<br> -->
			<TABLE id="datosPagoAlumno" class="display" cellSpacing=0 width="100%"> 
				<THEAD> 
					<TR> 
						<TH>Alumno</TH>
						<TH>Mes</TH>
