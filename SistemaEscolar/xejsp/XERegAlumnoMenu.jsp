...
<div class="content">        
     <ul class="ca-menu">
     				<li onclick="refreshPageRegAlta()">
                        <a href="">
                            <span class="ca-icon" id="heart">&#97;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">&nbsp;Nuevo &nbsp;Alumno</h2>
                                <h3 class="ca-sub">Registro de Nuevo Alumno</h3>
                            </div>
                        </a>
                    </li>
                     <li onclick="refreshPageReg()">
                        <a  href="">
                            <span class="ca-icon">&#185;</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Consulta de Solicitudes</h2>
                                <h3 class="ca-sub">Registro de Nuevos Alumnos</h3>
                            </div>
                        </a>
                    </li>
